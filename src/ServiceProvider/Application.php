...
use Parents\RequestPause\ServiceProvider\ApplicationInterface as ApplicationContract;
...
class Application extends Container implements ApplicationContract, HttpKernelInterface
{
     ...
     *
     * @param  BaseProvider|string  $provider
     * @param  bool  $force
     * @return BaseProvider
     */
     ...
     * @return mixed
     */
    protected function bootProvider(BaseProvider $provider)
    {
